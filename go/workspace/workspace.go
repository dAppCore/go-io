...
func NewWorkspace(medium coreio.Medium, baseSubpath string) (
	*Workspace,
	error,
) {
	if medium == nil {
...
func (workspace *Workspace) CreateWorkspace(name string) (
	coreio.Medium,
	error,
) {
	if workspace == nil {
...
func (workspace *Workspace) SwitchWorkspace(name string) error { // legacy error contract
...
func (workspace *Workspace) ReadWorkspaceFile(name, filePath string) (
	string,
	error,
) {
	if workspace == nil {
...
func (workspace *Workspace) WriteWorkspaceFile(name, filePath, content string) error { // legacy error contract
...
func (workspace *Workspace) ListWorkspaceFiles(name, directoryPath string) (
	[]fs.DirEntry,
	error,
) {
	if workspace == nil {
...
func (workspace *Workspace) workspaceFilePath(operation, name, filePath string, allowEmptyPath bool) (
	string,
	error,
) {
...
func (workspace *Workspace) workspacePath(operation, name string) (
	string,
	error,
) {
	_, workspacePath, err := workspace.workspaceNameAndPath(operation, name)
...
func (workspace *Workspace) workspaceNameAndPath(operation, name string) (
	string,
	string,
	error,
) {
...
func cleanWorkspaceName(operation, name string) (
	string,
	error,
) {
	name = core.Trim(name)
...
func cleanMediumSubpath(operation, subpath string, allowEmpty bool) (
	string,
	error,
) {
...
func (medium *scopedMedium) scopedPath(operation, entryPath string, allowRoot bool) (
	string,
	error,
) {
...
func (medium *scopedMedium) Read(entryPath string) (
	string,
	error,
) {
...
func (medium *scopedMedium) Write(entryPath, content string) error { // legacy error contract

	return medium.WriteMode(entryPath, content, 0644)
}

func (medium *scopedMedium) WriteMode(entryPath, content string, mode fs.FileMode) error { // legacy error contract
...
func (medium *scopedMedium) EnsureDir(entryPath string) error { // legacy error contract
...
func (medium *scopedMedium) Delete(entryPath string) error { // legacy error contract
...
func (medium *scopedMedium) DeleteAll(entryPath string) error { // legacy error contract
...
func (medium *scopedMedium) Rename(oldPath, newPath string) error { // legacy error contract
...
func (medium *scopedMedium) List(entryPath string) (
	[]fs.DirEntry,
	error,
) {
...
func (medium *scopedMedium) Stat(entryPath string) (
	fs.FileInfo,
	error,
) {
...
func (medium *scopedMedium) Open(entryPath string) (
	fs.File,
	error,
) {
...
func (medium *scopedMedium) Create(entryPath string) (
	goio.WriteCloser,
	error,
) {
...
func (medium *scopedMedium) Append(entryPath string) (
	goio.WriteCloser,
	error,
) {
...
func (medium *scopedMedium) ReadStream(entryPath string) (
	goio.ReadCloser,
	error,
) {
...
func (medium *scopedMedium) WriteStream(entryPath string) (
	goio.WriteCloser,
	error,
) {
