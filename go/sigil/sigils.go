...
func (sigil *ReverseSigil) In(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *ReverseSigil) Out(data []byte) (
	[]byte,
	error,
) {
...
func (sigil *HexSigil) In(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *HexSigil) Out(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *Base64Sigil) In(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *Base64Sigil) Out(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (buffer *sigilBuffer) Write(data []byte) (
	int,
	error,
) {
...
func (sigil *GzipSigil) In(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *GzipSigil) Out(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *JSONSigil) In(data []byte) (
	[]byte,
	error,
) {
	if data == nil {
...
func (sigil *JSONSigil) Out(data []byte) (
	[]byte,
	error,
) {
	return data, nil
...
func (sigil *HashSigil) In(data []byte) (
	[]byte,
	error,
) {
...
func (sigil *HashSigil) Out(data []byte) (
	[]byte,
	error,
) {
	return data, nil
...
func NewSigil(sigilName string) (
	Sigil,
	error,
) {
