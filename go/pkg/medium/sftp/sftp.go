...
func sshConfig(options Options) (
	*ssh.ClientConfig,
	error,
) {
...
func (medium *Medium) requiredRemotePath(operation, filePath string) (
	string,
	error,
) {
...
func (medium *Medium) ensureParent(remotePath string) error { // legacy error contract
