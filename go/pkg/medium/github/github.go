...
func tokenFileMedium(tokenFile string) (
	coreio.Medium,
	string,
	error,
) {
...
func setClientBaseURL(client *gh.Client, baseURL string) error { // legacy error contract
...
func requiredPath(operation, filePath string) (
	string,
	error,
) {
...
func (medium *Medium) getContents(operation, filePath string) (
...
func wrapGitHubError(operation, filePath string, err error) error { // legacy error contract
...
func readOnly(operation string) error { // legacy error contract
...
func (medium *Medium) listRecursive(filePath string) (
	[]fs.DirEntry,
	error,
) {
...
func (medium *Medium) Clone(filePath string) (
	map[string]string,
	error,
) {
...
func (medium *Medium) cloneWithBorg(filePath string) (
	map[string]string,
	error,
) {
...
func collectBorgDataNodeContents(dataNode *borgdatanode.DataNode, clean string) (
	map[string]string,
	error,
) {
	if dataNode == nil {
...
func collectBorgDataNodeDir(dataNode *borgdatanode.DataNode, dirPath string, contents map[string]string) error { // legacy error contract
...
func readBorgDataNodeFile(dataNode *borgdatanode.DataNode, filePath string) (
	string,
	error,
) {
...
func (medium *Medium) cloneWithContentsAPI(filePath string) (
	map[string]string,
	error,
) {
	clean := cleanRelative(filePath)
...
func (file *githubFile) Read(data []byte) (
	int,
	error,
) {
	if file.closed {
...
func (file *githubFile) Close() error { // legacy error contract
