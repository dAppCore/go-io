...
func dispatchMediumOperation(ctx context.Context, medium coreio.Medium, op string, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func readMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func writeMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func writeModeMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func ensureDirMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func isFileMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func deleteMediumOperation(ctx context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
	if req.Recursive {
...
func deleteAllMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func renameMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func listMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func statMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func openMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func createMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func appendMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func readStreamMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func writeStreamMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func existsMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func isDirMediumOperation(_ context.Context, medium coreio.Medium, req mediumRequest) (
	mediumResponse,
	error,
) {
...
func readAllContent(reader goio.Reader) (
	mediumResponse,
	error,
) {
...
func fileModeValue(value any, fallback fs.FileMode) (
	fs.FileMode,
	error,
) {
	if value == nil {
...
func writeAndClose(writer goio.WriteCloser, content string) error { // legacy error contract
