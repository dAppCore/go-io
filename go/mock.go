...
func (m *MockMedium) Read(path string) (
	string,
	error,
) {
	m.mu.RLock()
...
func (m *MockMedium) Write(path, content string) error { // legacy error contract

	return m.WriteMode(path, content, 0644)
}

func (m *MockMedium) WriteMode(path, content string, mode fs.FileMode) error { // legacy error contract
...
func (m *MockMedium) EnsureDir(path string) error { // legacy error contract
...
func (m *MockMedium) Delete(path string) error { // legacy error contract
...
func (m *MockMedium) DeleteAll(path string) error { // legacy error contract
...
func (m *MockMedium) Rename(oldPath, newPath string) error { // legacy error contract
...
func (m *MockMedium) List(path string) (
	[]fs.DirEntry,
	error,
) {
	m.mu.RLock()
...
func (m *MockMedium) Stat(path string) (
	fs.FileInfo,
	error,
) {
	m.mu.RLock()
...
func (m *MockMedium) Open(path string) (
	fs.File,
	error,
) {
	m.mu.RLock()
...
func (m *MockMedium) Create(path string) (
	goio.WriteCloser,
	error,
) {
...
func (m *MockMedium) Append(path string) (
	goio.WriteCloser,
	error,
) {
	m.mu.RLock()
...
func (m *MockMedium) ReadStream(path string) (
	goio.ReadCloser,
	error,
) {
	m.mu.RLock()
...
func (m *MockMedium) WriteStream(path string) (
	goio.WriteCloser,
	error,
) {
...
func (w *MockWriteCloser) Write(p []byte) (
	int,
	error,
) {
...
func (w *MockWriteCloser) Close() error { // legacy error contract
