...
func deleteObjectsError(prefix string, errs []types.Error) error { // legacy error contract
...
func readAllString(reader goio.ReadCloser) (
	string,
	error,
) {
...
func (medium *Medium) EnsureDir(directoryPath string) error { // legacy error contract
...
func (medium *Medium) deleteObjectBatch(prefix string, continuationToken *string) (
	*string,
	bool,
	error,
) {
...
func (file *s3File) Read(buffer []byte) (
	int,
	error,
) {
...
func (file *s3File) Close() error { // legacy error contract
...
func (writer *s3WriteCloser) Write(data []byte) (
	int,
	error,
) {
...
func (writer *s3WriteCloser) Close() error { // legacy error contract
