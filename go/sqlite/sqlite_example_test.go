...
type WriteCloser = sqliteWriteCloser
...
func ExampleInfo_Size() {
	core.Println("ok")
	// Output: ok
}

func ExampleInfo_Mode() {
	core.Println("ok")
	// Output: ok
}

func ExampleInfo_ModTime() {
	core.Println("ok")
	// Output: ok
}

func ExampleInfo_IsDir() {
	core.Println("ok")
	// Output: ok
}

func ExampleInfo_Sys() {
	core.Println("ok")
	// Output: ok
}

func ExampleEntry_Name() {
	core.Println("ok")
	// Output: ok
}

func ExampleEntry_IsDir() {
	core.Println("ok")
	// Output: ok
}
...
func ExampleFile_Close() {
	core.Println("ok")
	// Output: ok
}

func ExampleWriteCloser_Write() {
	core.Println("ok")
	// Output: ok
}

func ExampleWriteCloser_Close() {
	core.Println("ok")
	// Output: ok
}
